...
def main():
    ...
    if st.session_state.get("coach_feedback"):
        st.markdown(
            ...
            <div class="coach-badge">
                ...
                <span class="coach-badge-text"><strong>Coach:</strong> {st.session_state.coach_feedback}</span>
            </div>
            """,
            unsafe_allow_html=True,
        )
    ...
    if not workout_started:
        ...
        st.markdown(
            ...
            <div class="live-banner">
                ...
                Session Active — Camera & AI Coach Running
            </div>
            """,
            unsafe_allow_html=True,
        )
    ...
    if isinstance(user_id, int):
        ...
        if not df.empty:
            ...
            st.info("No workout history yet — complete a session to see your stats here.")
